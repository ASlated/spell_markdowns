...
__Components__ V S M (a twig from a tree that has been struck by lightning)
...
__Components__ V S M (a pickled octopus tentacle)
...
__Components__ V S M (a piece of tentacle from a giant octopus or a giant squid)
...
__Casting Time__ 8 hours

__Range__ Touch

__Components__ V S M (An agate worth at least 1,000 gp, which the spell consumes)
...
__Components__ V S M (one piece of ammunition or one thrown weapon)
...
__Components__ V S M (A small piece of iron)
...
__Components__ V S M (A pinch of sesame seeds)
...
__Components__ V S M (pieces of eggshell from two different kinds of creatures)
...
__Components__ V S M (Rare oils and unguents worth at least 1,000 gp, which the spell consumes)
...
__Components__ V M (Rare chalks and inks infused with precious gems with 50 gp, which the spell consumes)
...
__Components__ V S M (A pinch of powder made by crushing a clear gemstone)
...
__Components__ V S M (A small block of granite)
...
You create linked teleportation portals that remain open for the duration. Choose two points on the ground that you can see, one point within 10 feet of you and one point within 500 feet of you. A circular portal, 10 feet in diameter, opens over each point. If the portal would open in the space occupied by a cerature, the spell fails, and the casting is lost.
The portals are two-dimenional glowing rings filled with mist, hovering inches from the ground and perpendicular to it at the points you choose. A ring is visible only from one side (your choice), which is the rule that functions as a portal.
...
__Components__ V S M (A bit of fur; a piece of amber, glass, or a crystal rod; and three silver pins)
...
__Components__ V S M (The powder of a crushed black pearl worth at least 500 gp)
...
__Components__ V S M (A statuette of yourself carved from ivory and decorated with gems worth at least 1,500 gp)
...
__Components__ V S M (A lodestone and a pinch of dust)
...
__Components__ V S M (a sapphire worth 1,000 gp)

__Duration__ Until dispelled

You touch an object weighing 10 pounds or less whose longest dimension is 6 feet or less. The spell leaves an invisible mark on its surface and invisibly inscribes the name of the item on the sapphire you use as the material component. Each time you cast this spell, you must use a different sapphire.
At any time thereafter, you can use your action to speak the item's name and crush the sapphire. The item instantly appears in your hand regardless of physical or planar distances, and the spells ends.
If another creature is holding or carrying the item, crushing the sapphire doesn't transport the item to you, but instead you learn who the creature possesing the object is and roughly where that creature iss located at that moment.
Dispel magic or a similar effect successfully appliedto the sapphire ends this spell's effect.
...
__Components__ V S M (A pinch of lime, water, and earth)
...
__Components__ V S M (A glass or crystal bead that shatters when the spell ends)
...
__Components__ V S M (Burning incense, a small measure of brimstone and oil, a knotted string, a small amount of umber hulk blood, and a small silver rod worth at least 10 gp)
...
__Components__ V S M (A gem, crystal, reliquary, or some other ornamental container worth at least 500 gp)
...
__Components__ V S M (An iron blade and a small bag containing a mixture of soils—clay, loam, and sand)

__Duration__ Up to 2 hours
...
__Components__ V S M (a small crystal sphere)
...
__Components__ V S M (A bit of fleece and jade dust worth at least 25 gp)
...
__Components__ V S M (A magnifying glass)
...
__Components__ V S M (A small piece of quartz)
...
__Components__ V S M (A handful of thorns)
...
__Components__ V S M (Fire and holy water)
...
__Components__ V S M (Ruby dust worth 1,500 gp)
...
__Components__ V S M (a miniature portal carved from ivory, a small piece of polished marble, and a tiny silver spoon, each item worth at least 5 gp)
...
__Components__ V S M (a miniature platinum sword with a grip and pommel of copper and zinc, worth 250 gp)
...
__Components__ V S M (A small replica of you made from materials worth at least 5 gp)
...
__Components__ V S M (A lodestone and iron filings)
...
__Components__ V S M (A powder composed of diamond, emerald, ruby, and sapphire dust worth at least 5,000 gp, which the spell consumes)
...
__Components__ V S M (Snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; some hair, fingernail clippings, or other piece of that creature's body placed inside the snow or ice; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell)
...
__Components__ V S M (Either a lump of alum soaked in vinegar for the antipathy effect or a drop of honey for the sympathy effect)
...
__Components__ V S M (A diamond worth at least 1,000 gp and at least 1 cubic inch of flesh of the creature that is to be cloned, which the spell consumes, and a vessel worth at least 2,000 gp that has a sealable lid and is large enough to hold a Medium creature, such as a huge urn, coffin, mud-filled cyst in the ground, or crystal container filled with salt water)
...
__Components__ V S M (A handful of clay, crystal, glass, or mineral spheres)
...
__Components__ V S M (Fire and a piece of sunstone)
...
__Components__ V S M (a pair of linked silver rings)

__Duration__ 24 hours

You create a telepathic link between yourself and a willing crealure with which you are familiar. The creature can be anywhere on the same plane of exislence as you. The spell ends if you or the largel are no longer on the same plane.
Until the spell ends, you and the target can inslantaneously share words, images, sounds, and other sensory messages with one another through the Iink, and the target recognizes you as the creature it is communicating with. The spell enables a creature wilh an Intelligence score of at least I to understand the meaning of your words and lake in the scope of any sensory messages you send lo 11.
...
__Duration__ Concentration, up to 6 rounds

A wail of water springs into existence at a point you choose within range. You can make the wall up to 300 feet long, 300 feet high, and 50 feet thick. The wall lasts for the duration.
...
__Components__ V S M (A hummingbird feather)
...
__Components__ V S M (A vellum depiction or a carved statuette in the likeness of the target, and a special component that varies according to the version of the spell you choose, worth at least 500gp per Hit Die of the target)
...
__Components__ V S M (A jade circlet worth at least 1,500 gp, which you must place on your head before you cast the spell)
...
__Components__ V S M (A drop of mercury, a dollop of gum arabic, and a wisp of smoke)
